...
- (void)showBageView:(NSString *)value index:(NSInteger)index
{
    CustomButton *tabBarBtn = [_tabbarBtnArray objectAtIndex:index];
    CGFloat btnW = self.frame.size.width/5;
    
    btnW = - btnW * 0.5 + 10;
    
    [tabBarBtn setBadgeCenterOffset:CGPointMake(btnW, 4)];
    [tabBarBtn showNumberBadgeWithValue:[value integerValue]];
}
