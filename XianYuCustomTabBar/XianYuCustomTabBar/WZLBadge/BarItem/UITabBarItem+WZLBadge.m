...
static char bageCustomTabbarValueKey;
...
{
    objc_setAssociatedObject(self, &bageCustomTabbarValueKey, bageValue, OBJC_ASSOCIATION_RETAIN);

}

- (NSString *)badgeValue
{
    return objc_getAssociatedObject(self, &bageCustomTabbarValueKey);
